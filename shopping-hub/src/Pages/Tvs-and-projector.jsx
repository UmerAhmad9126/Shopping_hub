...
const getData = (page = 1) => {
    return fetch(`http://localhost:3000/tvs-and-projector?_page=${page}&_limit=9`)
        .then((res) => res.json())
}

const TvsAndProjector = () => {
    ...
    return (
        <div>
            ...
            <Pagination page={page} handlePageChange={handlePageChange} total={2} />
        </div>
    )
}

export default TvsAndProjector;